        ...
        {CHAMPIONS.map((champion, index) => {
          ...
          <motion.div
            ...
            <div className="relative p-6 md:p-8">
              ...
              <motion.div 
                className={`text-center flex items-end justify-center h-96 ${champion.id === 'ren' ? 'items-center' : ''} mb-4`}
              ...
              >
                {champion.sprite.startsWith('http') ? (
                  <motion.img 
                    src={champion.sprite} 
                    alt={champion.name}
                    className={`object-contain ${champion.id === 'ren' ? 'w-[276px] h-[276px] md:w-[346px] md:h-[346px]' : 'w-48 h-48 md:w-56 md:h-56'}`}
